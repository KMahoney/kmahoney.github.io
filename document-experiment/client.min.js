var y={leftmin:2,rightmin:2,patterns:{3:"",
...
10:"se1mi6t5ic3tro1le1um5sa3par5iloli3gop1o1am1en3ta5bath3er1o1s3slova1kia3s2og1a1myo3no2t1o3nc2tro3me6c1cu2r1ance5noc3er1osth1o5gen1ih3i5pel1a4nfi6n3ites_ever5si5bs2s1a3chu1d1ri3pleg5_ta5pes1trproc3i3ty_s5sign5a3b3rab1o1loiitin5er5arwaste3w6a2mi1n2ut1erde3fin3itiquin5tes5svi1vip3a3r",11:"pseu3d6o3f2s2t1ant5shimi1n2ut1estpseu3d6o3d25tab1o1lismpo3lyph1onophi5lat1e3ltravers3a3bschro1ding12g1o4n3i1zat1ro1pol3it3trop1o5lis3trop1o5lesle3g6en2dreeth1y6l1eneor4tho3ni4t",12:"3ra4m5e1triz1e6p3i3neph1"}};function z(){this.s=A();this.q=y.leftmin;this.r=y.rightmin;this.i={};y.exceptions&&y.exceptions.split(/,\s?/g).forEach(function(f){var e=new RegExp(-1!==f.indexOf("=")?"=":"-","g");this.i[f.replace(e,"")]=f.split(e)},this)}
function A(){var f=y.patterns,e=0,d={m:[]},c;for(e in f)f.hasOwnProperty(e)&&(c=f[e].match(new RegExp(".{1,"+ +e+"}","g")),c.forEach(function(b){var a=b.replace(/[0-9]/g,"").split("");b=b.split(/\D/);var g=d;a.forEach(function(a){a=a.charCodeAt(0);g[a]||(g[a]={});g=g[a]});g.m=b.map(function(a){return a||0})}));return d}
function B(f,e){var d,c=[],b,a,g,t,n=[],p,r,l,k=Math.max,h=f.s,m=[""];if(f.i.hasOwnProperty(e))return f.i[e];if(-1!==e.indexOf("\u00ad"))return[e];e="_"+e+"_";d=e.toLowerCase().split("");b=e.split("");p=d.length;for(a=0;a<p;a+=1)n[a]=0,c[a]=d[a].charCodeAt(0);for(a=0;a<p;a+=1)for(t=h,d=a;d<p;d+=1)if(t=t[c[d]]){if(r=t.m)for(g=0,l=r.length;g<l;g+=1)n[a+g]=k(n[a+g],r[g])}else break;for(a=1;a<p-1;a+=1)a>f.q&&a<p-f.r&&n[a]%2?m.push(b[a]):m[m.length-1]+=b[a];return m};function D(f,e){var d=[],c=0;d.push({position:0,d:0,o:0,h:null});f.forEach(function(a,b){if(a.b){for(var n=null,p=Infinity,r=d.length-1;0<=r;r--){var l=d[r],k=c-l.o;k>e?d.splice(r,1):(k=(-Infinity===a.a?0:e-k+e*a.a)+l.d,k<p&&(n=l,p=k))}-Infinity===a.a&&(d=[]);if(n){k=c;for(r=b;r<f.length&&f[r].b;)k+=f[r].height,r++;d.push({position:b,d:p,o:k,h:n})}}c+=a.height});for(var b=d.reduce(function(a,b){return a.d<b.d?a:b}),a=[];null!==b;)a.push(b.position),b=b.h;return a.reverse()}
var H=function(){function f(d,c,b,a,g,f,e){return{position:d,d:c,g:b,line:a,p:g,l:f,h:e}}function e(d,c,b,a,g,e,n){for(var p={},r=d.length-1;0<=r;r--){var l=d[r],k;k=c.width-l.l.width+("penalty"===g.type?g.width:0);if(k<b){var h=c.stretch-l.l.stretch;k=0<h?(b-k)/h:Infinity}else k>b?(h=c.c-l.l.c,k=0<h?(b-k)/h:Infinity):k=0;(-1>k||"penalty"===g.type&&-Infinity===g.a)&&d.splice(r,1);if(-1<=k&&k<=a.tolerance){h=100*Math.pow(Math.abs(k),3);h="penalty"===g.type&&0<=g.a?Math.pow(a.cost.line+h+g.a,2):"penalty"===
g.type&&-Infinity!==g.a?Math.pow(a.cost.line+h-g.a,2):Math.pow(a.cost.line+h,2);"penalty"===g.type&&"penalty"===n[l.position].type&&(h+=a.cost.flagged*g.j*n[l.position].j);var m=-.5>k?0:.5>=k?1:1>=k?2:3;1<Math.abs(m-l.p)&&(h+=a.cost.fitness);h+=l.d;if(!p[m]||h<=p[m].d)p[m]={n:l,d:h,g:k}}}c={width:c.width,stretch:c.stretch,c:c.c};for(b=e;b<n.length;b++)if(a=n[b],"glue"===a.type)c.width+=a.width,c.stretch+=a.stretch,c.c+=a.c;else if("box"===a.type||"penalty"===a.type&&-Infinity===a.a&&b>e)break;for(n=
0;4>n;n++)(b=p[n])&&d.push(f(e,b.d,b.g,b.n.line+1,n,c,b.n))}return function(d,c,b){var a=$.extend({},{cost:{line:10,flagged:100,fitness:3E3},tolerance:10},b),g=[],t={width:0,stretch:0,c:0};g.push(f(0,0,0,0,0,{width:0,stretch:0,c:0},null));d.forEach(function(b,d,f){"box"===b.type?t.width+=b.width:"glue"===b.type?(0<d&&"box"===f[d-1].type&&e(g,t,c,a,b,d,f),t.width+=b.width,t.stretch+=b.stretch,t.c+=b.c):"penalty"===b.type&&Infinity!==b.a&&e(g,t,c,a,b,d,f)});d=g.reduce(function(a,b){return a.d<b.d?a:
b});for(b=[];null!==d;)b.push({position:d.position,g:d.g}),d=d.h;return b.reverse()}}();function I(f){var e=document,d;$(e).on("touchstart",function(c){c=c.originalEvent.changedTouches;1==c.length&&(d=c[0])});$(e).on("touchend",function(c){c=c.originalEvent.changedTouches;1==c.length&&c[0].identifier==d.identifier&&20<Math.sqrt(Math.pow(c[0].clientX-d.clientX,2)+Math.pow(c[0].clientY-d.clientY,2))&&f(d,c[0])})};var J={fontSize:18,lineHeight:26,bold:!1,k:!1,color:"black"},K=2*J.lineHeight+26;function L(f){return"H1"==f||"H2"==f}var M={H1:{fontSize:28,lineHeight:38,bold:!0},H2:{bold:!0},EM:{k:!0},STRONG:{bold:!0},A:{color:"blue"}};function N(f){return f.bold&&f.k?"bolditalic":f.bold?"bold":f.k?"italic":"normal"}function P(f){var e=J.lineHeight;return Math.ceil(f/e)*e-f}
function Q(f,e,d){e*=1/f.unitsPerEm;var c=0;d=f.stringToGlyphs(d);for(i=0;i<d.length;i+=1){var b=d[i];b.advanceWidth&&(c+=b.advanceWidth*e);i<d.length-1&&(c+=f.getKerningValue(b,d[i+1])*e)}return c}
function R(f,e,d){var c=new z,b=[];e.forEach(function(a,g,e){var n=a.style.fontSize,p=f[N(a.style)],r=Q(p,n,"-"),l=Q(p,n," "),k=3*l/6,h=3*l/9,m=B(c,a.text);1<m.length&&4<a.text.length?m.forEach(function(c,g,f){b.push({type:"box",width:Q(p,n,c),element:a.element,style:a.style,text:c});g!==f.length-1&&b.push({type:"penalty",width:r,a:d,j:1,style:a.style})}):b.push($.extend({},a,{type:"box",width:Q(p,n,a.text)}));g===e.length-1?(b.push({type:"glue",width:0,stretch:Infinity,c:0}),b.push({type:"penalty",
width:0,a:-Infinity,j:1})):b.push({type:"glue",width:l,stretch:k,c:h})});return b}function S(f,e,d){if(e.nodeType==e.TEXT_NODE)return e.data.split(/\s/).filter(function(a){return 0<a.length}).map(function(a){return{element:d,style:f,text:a}});for(var c=[],b=e.firstChild;b;){for(var a=$.extend({},f,M[b.tagName]),a=S(a,b,e),g=0;g<a.length;g++)c.push(a[g]);b=b.nextSibling}return c}
function T(f,e){for(var d=[],c=e.firstChild;c;){var b=c.tagName;if("P"===b||"H1"===b||"H2"===b){var a=$.extend({},J,M[b]),g=S(a,c,e),g=R(f,g,L(b)?500:100);d.push({style:a,element:c,e:g})}"IMG"===b&&d.push({element:c});c=c.nextSibling}return d}
function U(f,e,d){var c=$("canvas").get(0),b=c.getContext("2d");b.clearRect(0,0,c.width,c.height);b.fillStyle="black";b.fillRect(0,0,c.width,26);var a=f.bold.getPath(document.title,8,18,16);a.fill="white";a.draw(b);var a="Page "+(d+1)+"/"+e.length,g=Q(f.bold,16,a),a=f.bold.getPath(a,c.width-g-8,18,16);a.fill="white";a.draw(b);for(c=0;c<e[d].page.length;c++)a=e[d].page[c],a.element&&"IMG"===a.element.tagName?(b.strokeStyle="#EEEEEE",b.lineWidth=1,b.drawImage(a.element,a.x+a.f.x,a.y+a.f.y,a.f.width,
a.f.height),b.strokeRect(a.x,a.y,a.border.width,a.border.height)):(g=f[N(a.style)].getPath(a.text,a.x,a.y,a.style.fontSize),g.fill=a.style.color,g.draw(b))}function V(f,e,d){for(var c=0;c<f.links.length;c++){var b=f.links[c];if(e>=b.x&&e<=b.x+b.width&&d<=b.y&&d>=b.y-b.style.fontSize)return b}}
function W(f){function e(){var g=window.innerWidth,e=window.innerHeight;if(!a||g!=a.width||e!=a.height){for(var n=c,p=g-60,r=Math.floor(p/Math.min(p,520)),p=Math.min(p/r,600),l=[],k=0;k<n.length;k++){var h=n[k];if("IMG"===h.element.tagName){var h=h.element,m=p-60,q=m/h.width*h.height,s=P(q);l.push({b:!0,height:0,a:0});l.push({b:!1,height:s/2});l.push({height:q+J.lineHeight,element:h,border:{height:q,width:m},f:{x:(m-.9*m)/2,y:(q-.9*q)/2,width:.9*m,height:.9*q}});l.push({b:!1,height:s/2});l.push({b:!0,
height:J.lineHeight,a:0})}else if(m=H(h.e,p-60),L(h.element.tagName)){0<k&&!L(n[k-1].element.tagName)&&(s="H1"===h.element.tagName?-.15:-.05,l.push({b:!0,height:0,a:s}));s=P((m.length-1)*h.style.lineHeight);l.push({b:!1,height:s/2});for(q=1;q<m.length;q++)l.push({b:!1,height:h.style.lineHeight,e:h.e,start:m[q-1],end:m[q]});l.push({b:!1,height:s/2})}else{for(q=1;q<m.length;q++)l.push({b:!1,height:h.style.lineHeight,e:h.e,start:m[q-1],end:m[q]}),q<m.length-1&&(s=1==q||q==m.length-2?.3:.01,l.push({b:!0,
height:0,a:s}));l.push({b:!0,height:h.style.lineHeight,a:0})}}l.push({b:!0,height:0,a:-Infinity});for(var n=D(l,e-K-0),k=(g-p*Math.min(n.length-1,r))/2,s=K,h=0,m=[],q=[],C=[],E=0;E<l.length;E++){var u=l[E];if(E==n[m.length*r+h+1])h++,h>=r&&(h=0,m.push({page:q,links:C}),q=[],C=[]),s=K;else{if(u.element&&"IMG"===u.element.tagName){var w=30+h*p+k;q.push({element:u.element,x:w,y:s,border:u.border,f:u.f})}if(!u.b&&u.e){for(var x=u.e,O=u.start,F=u.end,w=30+h*p+k,G=O.position;G<F.position;G++){var v=x[G];
"box"==v.type?(v=$.extend({},v,{x:w,y:s}),q.push(v),"A"===v.element.tagName&&C.push(v),w+=v.width):"glue"==v.type&&G>O.position&&(w+=v.width+F.g*(0>F.g?v.c:v.stretch))}x=x[F.position];"penalty"==x.type&&-Infinity!=x.a&&q.push({text:"-",style:x.style,x:w,y:s})}if(s>K||!u.b)s+=u.height}}0<q.length&&m.push({page:q,links:C});a=m;b=Math.min(a.length-1,b);d.prop({width:g,height:e});U(f,a,b)}}var d=$("canvas"),c=T(f,d.get(0));$(window);var b=0,a;e();$(window).resize(e);$("img").load(e);d.on("mousemove",
function(c){c=V(a[b],c.clientX,c.clientY);d.toggleClass("link",c&&c.element?!0:!1)});d.on("click",function(c){var d=V(a[b],c.clientX,c.clientY);d&&d.element&&(c=new MouseEvent("click",{button:c.button,metaKey:c.metaKey,ctrlKey:c.ctrlKey}),d.element.dispatchEvent(c))});I(function(c,d){b=c.clientX<d.clientX?Math.max(b-1,0):Math.min(a.length-1,b+1);U(f,a,b)});$(document).on("keydown",function(c){if(37==c.which||38==c.which)b=Math.max(b-1,0),U(f,a,b),c.preventDefault();else if(39==c.which||40==c.which||
32==c.which)b=Math.min(a.length-1,b+1),U(f,a,b),c.preventDefault()})}function X(f){return $.Deferred(function(e){opentype.load(f,function(d,c){e.resolve(c)})})}$.when(X("fonts/cmunss.otf"),X("fonts/cmunsx.otf"),X("fonts/cmunsi.otf"),X("fonts/cmunso.otf")).done(function(f,e,d,c){var b={normal:f,bold:e,italic:d,bolditalic:c};$(function(){W(b)})});
