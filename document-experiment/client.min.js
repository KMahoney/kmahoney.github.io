...
10:"se1mi6t5ic3tro1le1um5sa3par5iloli3gop1o1am1en3ta5bath3er1o1s3slova1kia3s2og1a1myo3no2t1o3nc2tro3me6c1cu2r1ance5noc3er1osth1o5gen1ih3i5pel1a4nfi6n3ites_ever5si5bs2s1a3chu1d1ri3pleg5_ta5pes1trproc3i3ty_s5sign5a3b3rab1o1loiitin5er5arwaste3w6a2mi1n2ut1erde3fin3itiquin5tes5svi1vip3a3r",11:"pseu3d6o3f2s2t1ant5shimi1n2ut1estpseu3d6o3d25tab1o1lismpo3lyph1onophi5lat1e3ltravers3a3bschro1ding12g1o4n3i1zat1ro1pol3it3trop1o5lis3trop1o5lesle3g6en2dreeth1y6l1eneor4tho3ni4t",12:"3ra4m5e1triz1e6p3i3neph1"}};function z(){this.r=A();this.p=y.leftmin;this.q=y.rightmin;this.h={};y.exceptions&&y.exceptions.split(/,\s?/g).forEach(function(f){var g=new RegExp(-1!==f.indexOf("=")?"=":"-","g");this.h[f.replace(g,"")]=f.split(g)},this)}
function A(){var f=y.patterns,g=0,e={l:[]},d;for(g in f)f.hasOwnProperty(g)&&(d=f[g].match(new RegExp(".{1,"+ +g+"}","g")),d.forEach(function(b){var a=b.replace(/[0-9]/g,"").split("");b=b.split(/\D/);var c=e;a.forEach(function(a){a=a.charCodeAt(0);c[a]||(c[a]={});c=c[a]});c.l=b.map(function(a){return a||0})}));return e}
function C(f,g){var e,d=[],b,a,c,r,l=[],p,q,m,k=Math.max,h=f.r,n=[""];if(f.h.hasOwnProperty(g))return f.h[g];if(-1!==g.indexOf("\u00ad"))return[g];g="_"+g+"_";e=g.toLowerCase().split("");b=g.split("");p=e.length;for(a=0;a<p;a+=1)l[a]=0,d[a]=e[a].charCodeAt(0);for(a=0;a<p;a+=1)for(r=h,e=a;e<p;e+=1)if(r=r[d[e]]){if(q=r.l)for(c=0,m=q.length;c<m;c+=1)l[a+c]=k(l[a+c],q[c])}else break;for(a=1;a<p-1;a+=1)a>f.p&&a<p-f.q&&l[a]%2?n.push(b[a]):n[n.length-1]+=b[a];return n};function G(f,g){var e=[],d=0;e.push({position:0,c:0,n:0,g:null});f.forEach(function(a,b){if(a.d){for(var l=null,p=Infinity,q=e.length-1;0<=q;q--){var m=e[q],k=d-m.n;k>g?e.splice(q,1):(k=(-Infinity===a.a?0:g-k+g*a.a)+m.c,k<p&&(l=m,p=k))}-Infinity===a.a&&(e=[]);if(l){k=d;for(q=b;q<f.length&&f[q].d;)k+=f[q].height,q++;e.push({position:b,c:p,n:k,g:l})}}d+=a.height});for(var b=e.reduce(function(a,b){return a.c<b.c?a:b}),a=[];null!==b;)a.push(b.position),b=b.g;return a.reverse()}
var H=function(){function f(e,d,b,a,c,f,g){return{position:e,c:d,f:b,line:a,o:c,k:f,g:g}}function g(e,d,b,a,c,g,l){for(var p={},q=e.length-1;0<=q;q--){var m=e[q],k;k=d.width-m.k.width+("penalty"===c.type?c.width:0);if(k<b){var h=d.stretch-m.k.stretch;k=0<h?(b-k)/h:Infinity}else k>b?(h=d.b-m.k.b,k=0<h?(b-k)/h:Infinity):k=0;(-1>k||"penalty"===c.type&&-Infinity===c.a)&&e.splice(q,1);if(-1<=k&&k<=a.tolerance){h=100*Math.pow(Math.abs(k),3);h="penalty"===c.type&&0<=c.a?Math.pow(a.cost.line+h+c.a,2):"penalty"===
c.type&&-Infinity!==c.a?Math.pow(a.cost.line+h-c.a,2):Math.pow(a.cost.line+h,2);"penalty"===c.type&&"penalty"===l[m.position].type&&(h+=a.cost.flagged*c.i*l[m.position].i);var n=-.5>k?0:.5>=k?1:1>=k?2:3;1<Math.abs(n-m.o)&&(h+=a.cost.fitness);h+=m.c;if(!p[n]||h<=p[n].c)p[n]={m:m,c:h,f:k}}}d={width:d.width,stretch:d.stretch,b:d.b};for(b=g;b<l.length;b++)if(a=l[b],"glue"===a.type)d.width+=a.width,d.stretch+=a.stretch,d.b+=a.b;else if("box"===a.type||"penalty"===a.type&&-Infinity===a.a&&b>g)break;for(l=
0;4>l;l++)(b=p[l])&&e.push(f(g,b.c,b.f,b.m.line+1,l,d,b.m))}return function(e,d,b){var a=$.extend({},{cost:{line:10,flagged:100,fitness:3E3},tolerance:3},b),c=[],r={width:0,stretch:0,b:0};c.push(f(0,0,0,0,0,{width:0,stretch:0,b:0},null));e.forEach(function(b,e,f){"box"===b.type?r.width+=b.width:"glue"===b.type?(0<e&&"box"===f[e-1].type&&g(c,r,d,a,b,e,f),r.width+=b.width,r.stretch+=b.stretch,r.b+=b.b):"penalty"===b.type&&Infinity!==b.a&&g(c,r,d,a,b,e,f)});e=c.reduce(function(a,b){return a.c<b.c?a:
b});for(b=[];null!==e;)b.push({position:e.position,f:e.f}),e=e.g;return b.reverse()}}();function I(f){var g=document,e;$(g).on("touchstart",function(d){d=d.originalEvent.changedTouches;1==d.length&&(e=d[0])});$(g).on("touchend",function(d){d=d.originalEvent.changedTouches;1==d.length&&d[0].identifier==e.identifier&&20<Math.sqrt(Math.pow(d[0].clientX-e.clientX,2)+Math.pow(d[0].clientY-e.clientY,2))&&f(e,d[0])})};var J={fontSize:18,lineHeight:26,bold:!1,j:!1,color:"black"},K=2*J.lineHeight+26;function L(f){return"H1"==f||"H2"==f}var M={H1:{fontSize:28,lineHeight:38,bold:!0},H2:{bold:!0},EM:{j:!0},STRONG:{bold:!0},A:{color:"blue"}};function O(f){return f.bold&&f.j?"bolditalic":f.bold?"bold":f.j?"italic":"normal"}
function P(f,g,e){g*=1/f.unitsPerEm;var d=0;e=f.stringToGlyphs(e);for(i=0;i<e.length;i+=1){var b=e[i];b.advanceWidth&&(d+=b.advanceWidth*g);i<e.length-1&&(d+=f.getKerningValue(b,e[i+1])*g)}return d}
function Q(f,g,e){var d=new z,b=[];g.forEach(function(a,c,g){var l=a.style.fontSize,p=f[O(a.style)],q=P(p,l,"-"),m=P(p,l," "),k=3*m/6,h=3*m/9,n=C(d,a.text);1<n.length&&4<a.text.length?n.forEach(function(c,d,f){b.push({type:"box",width:P(p,l,c),element:a.element,style:a.style,text:c});d!==f.length-1&&b.push({type:"penalty",width:q,a:e,i:1,style:a.style})}):b.push($.extend({},a,{type:"box",width:P(p,l,a.text)}));c===g.length-1?(b.push({type:"glue",width:0,stretch:Infinity,b:0}),b.push({type:"penalty",
width:0,a:-Infinity,i:1})):b.push({type:"glue",width:m,stretch:k,b:h})});return b}function R(f,g,e){if(g.nodeType==g.TEXT_NODE)return g.data.split(/\s/).filter(function(a){return 0<a.length}).map(function(a){return{element:e,style:f,text:a}});for(var d=[],b=g.childNodes,a=0;a<b.length;a++)for(var c=b.item(a),r=$.extend({},f,M[c.tagName]),c=R(r,c,g),r=0;r<c.length;r++)d.push(c[r]);return d}
function S(f,g){for(var e=[],d=g.childNodes,b=0;b<d.length;b++){var a=d.item(b),c=a.tagName;if("P"===c||"H1"===c||"H2"===c){var r=$.extend({},J,M[c]),l=R(r,a,g),c=Q(f,l,L(c)?500:100);e.push({style:r,element:a,e:c})}}return e}
function T(f,g,e){var d=$("canvas").get(0),b=d.getContext("2d");b.clearRect(0,0,d.width,d.height);b.fillStyle="black";b.fillRect(0,0,d.width,26);var a=f.bold.getPath(document.title,8,18,16);a.fill="white";a.draw(b);var a="Page "+(e+1)+"/"+g.length,c=P(f.bold,16,a),a=f.bold.getPath(a,d.width-c-8,18,16);a.fill="white";a.draw(b);for(d=0;d<g[e].page.length;d++)a=g[e].page[d],c=f[O(a.style)].getPath(a.text,a.x,a.y,a.style.fontSize),c.fill=a.style.color,c.draw(b)}
function U(f,g,e){for(var d=0;d<f.links.length;d++){var b=f.links[d];if(g>=b.x&&g<=b.x+b.width&&e<=b.y&&e>=b.y-b.style.fontSize)return b}}
function V(f){function g(){var c=window.innerWidth,g=window.innerHeight;if(!a||c!=a.width||g!=a.height){for(var l=d,p=c-60,q=Math.floor(p/Math.min(p,520)),p=Math.min(p/q,600),m=[],k=0;k<l.length;k++){var h=l[k],n=H(h.e,p-60);if(L(h.element.tagName)){if(0<k&&!L(l[k-1].element.tagName)){var t="H1"===h.element.tagName?-.15:-.05;m.push({d:!0,height:0,a:t})}var s=(n.length-1)*h.style.lineHeight,t=J.lineHeight,t=Math.ceil(s/t)*t-s;m.push({d:!1,height:t/2});for(s=1;s<n.length;s++)m.push({d:!1,height:h.style.lineHeight,
e:h.e,start:n[s-1],end:n[s]});m.push({d:!1,height:t/2})}else{for(s=1;s<n.length;s++)m.push({d:!1,height:h.style.lineHeight,e:h.e,start:n[s-1],end:n[s]}),s<n.length-1&&(t=1==s||s==n.length-2?.3:.01,m.push({d:!0,height:0,a:t}));m.push({d:!0,height:h.style.lineHeight,a:0})}}m.push({d:!0,height:0,a:-Infinity});for(var l=G(m,g-K-0),k=(c-p*Math.min(l.length-1,q))/2,h=K,n=0,s=[],t=[],B=[],D=0;D<m.length;D++){var v=m[D];if(D==l[s.length*q+n+1])n++,n>=q&&(n=0,s.push({page:t,links:B}),t=[],B=[]),h=K;else{if(!v.d&&
v.e){for(var w=v.e,N=v.start,E=v.end,x=30+n*p+k,F=N.position;F<E.position;F++){var u=w[F];"box"==u.type?(u=$.extend({},u,{x:x,y:h}),t.push(u),"A"===u.element.tagName&&B.push(u),x+=u.width):"glue"==u.type&&F>N.position&&(x+=u.width+E.f*(0>E.f?u.b:u.stretch))}w=w[E.position];"penalty"==w.type&&-Infinity!=w.a&&t.push({text:"-",style:w.style,x:x,y:h})}if(h>K||!v.d)h+=v.height}}0<t.length&&s.push({page:t,links:B});a=s;b=Math.min(a.length-1,b);e.prop({width:c,height:g});T(f,a,b)}}var e=$("canvas"),d=S(f,
e.get(0));$(window);var b=0,a;g();$(window).resize(g);e.on("mousemove",function(c){c=U(a[b],c.clientX,c.clientY);e.toggleClass("link",c&&c.element?!0:!1)});e.on("click",function(c){var d=U(a[b],c.clientX,c.clientY);d&&d.element&&(c=new MouseEvent("click",{button:c.button,metaKey:c.metaKey,ctrlKey:c.ctrlKey}),d.element.dispatchEvent(c))});I(function(c,d){b=c.clientX<d.clientX?Math.max(b-1,0):Math.min(a.length-1,b+1);T(f,a,b)});$(document).on("keydown",function(c){if(37==c.which||38==c.which)b=Math.max(b-
1,0),T(f,a,b),c.preventDefault();else if(39==c.which||40==c.which||32==c.which)b=Math.min(a.length-1,b+1),T(f,a,b),c.preventDefault()})}function W(f){return $.Deferred(function(g){opentype.load(f,function(e,d){g.resolve(d)})})}$.when(W("fonts/cmunss.otf"),W("fonts/cmunsx.otf"),W("fonts/cmunsi.otf"),W("fonts/cmunso.otf")).done(function(f,g,e,d){var b={normal:f,bold:g,italic:e,bolditalic:d};$(function(){V(b)})});
